...
def generate():
    ...
    nmdef = (random_line('namelist.txt'))
    nick = nmdef + "_" + getRandomString(random.randint(6, 10))
    passw = getRandomString(random.randint(18, 22))
    email = nmdef+getRandomString(random.randint(6, 10))+"@gmail"+".com"
